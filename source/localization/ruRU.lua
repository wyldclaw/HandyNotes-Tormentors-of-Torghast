...
L["schedule_desc"] = "Это |cFFFF0000НЕ|r настоящий босс, только для того, чтобы показать общую добычу и порядок появления боссов. Интервал возрождения боссов - 2 часа.|n|n12/2/4/6/8/10 PST или 1/3/5/7/9/11 EST";
...
L["context_menu_title"] = "HandyNotes Мучители из Торгаста";
...
L["options_poi_color"] = "Цвет точек"
L["options_poi_color_desc"] = "Устанавливает цвет интереса, когда значок находится в фокусе."
L["options_path_color"] = "Цвет пути"
L["options_path_color_desc"] = "Устанавливает цвет пути, когда значок находится в фокусе."
L["options_reset_poi_colors"] = "Сбросить цвета"
L["options_reset_poi_colors_desc"] = "Восстановите значения по умолчанию для вышеуказанных цветов."
