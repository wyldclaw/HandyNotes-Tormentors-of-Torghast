...
L["schedule_desc"] = "Это |cFFFF0000NOT|r настоящий босс, только для того, чтобы показать общую добычу и порядок появления боссов. Интервал возрождения боссов - 2 часа.|n|n12/2/4/6/8/10 PST или 1/3/5/7/9/11 EST";
